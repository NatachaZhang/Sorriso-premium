...
<body class="font-sans antialiased bg-slate-50 pt-[104px]">
  ...
  <section class="bg-blue-900 text-white py-16 md:py-20">
    <div class="max-w-6xl mx-auto px-4 grid md:grid-cols-2 gap-8 items-center">
      <div>
        ...
        <a href="marcacoes.php?tratamento=consulta&origem=corpo-clinico"
      ...
      <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6" id="lista-medicos">
        <article class="doctor-wrapper" data-especialidade="Ortodontia">
          <div class="bg-white rounded-2xl shadow-md p-5 text-center">
            ...
            <a href="marcacoes.php?dentista=Dr.%20Afonso%20Nunes&especialidade=Ortodontia&origem=corpo-clinico" class="mt-3 inline-flex items-center rounded-full border border-sky-500 px-3 py-1 text-xs text-sky-600 hover:bg-sky-50">
              Marcar consulta
            </a>
          </div>
        </article>
        ...
        <article class="doctor-wrapper" data-especialidade="Ortodontia">
          <div class="bg-white rounded-2xl shadow-md p-5 text-center">
            ...
            <a href="marcacoes.php?dentista=Dra.%20Diana%20Figueiredo&especialidade=Ortodontia&origem=corpo-clinico" class="mt-3 inline-flex items-center rounded-full border border-sky-500 px-3 py-1 text-xs text-sky-600 hover:bg-sky-50">
              Marcar consulta
            </a>
          </div>
        </article>
        ...
        <article class="doctor-wrapper" data-especialidade="Odontopediatria">
          <div class="bg-white rounded-2xl shadow-md p-5 text-center">
            ...
            <h3 class="text-sm font-semibold">Dr. Mateus Afonso</h3>
            <p class="mt-1 text-xs text-slate-500">
              Especialista em odontopediatria e acompanhamento de crianças ansiosas.
            </p>
            <a href="marcacoes.php?especialidade=Odontopediatria&origem=corpo-clinico" class="mt-3 inline-flex items-center rounded-full border border-sky-500 px-3 py-1 text-xs text-sky-600 hover:bg-sky-50">
              Marcar consulta
            </a>
          </div>
        </article>
        ...
        <article class="doctor-wrapper" data-especialidade="Odontopediatria">
          <div class="bg-white rounded-2xl shadow-md p-5 text-center">
            ...
            <a href="marcacoes.php?dentista=Dra.%20Rita%20Vinagreiro&especialidade=Odontopediatria&origem=corpo-clinico" class="mt-3 inline-flex items-center rounded-full border border-sky-500 px-3 py-1 text-xs text-sky-600 hover:bg-sky-50">
              Marcar consulta
            </a>
          </div>
        </article>
        ...
        <article class="doctor-wrapper" data-especialidade="Implantes">
          <div class="bg-white rounded-2xl shadow-md p-5 text-center">
            ...
            <h3 class="text-sm font-semibold">Dr. Rodrigo Ferrão</h3>
            <p class="mt-1 text-xs text-slate-500">
              Focado em reabilitação oral com implantes e próteses.
            </p>
            <a href="marcacoes.php?especialidade=Implantes&origem=corpo-clinico" class="mt-3 inline-flex items-center rounded-full border border-sky-500 px-3 py-1 text-xs text-sky-600 hover:bg-sky-50">
              Marcar consulta
            </a>
          </div>
        </article>
        ...
        <article class="doctor-wrapper" data-especialidade="Estética Dental">
          <div class="bg-white rounded-2xl shadow-md p-5 text-center">
            ...
            <a href="marcacoes.php?dentista=Dra.%20Iara%20Gomes&especialidade=Est%C3%A9tica%20dental&origem=corpo-clinico" class="mt-3 inline-flex items-center rounded-full border border-sky-500 px-3 py-1 text-xs text-sky-600 hover:bg-sky-50">
              Marcar consulta
            </a>
          </div>
        </article>
        ...
        <article class="doctor-wrapper" data-especialidade="Periodontia">
          <div class="bg-white rounded-2xl shadow-md p-5 text-center">
            ...
            <a href="marcacoes.php?dentista=Dra.%20Ana%20Silva&especialidade=Periodontia&origem=corpo-clinico" class="mt-3 inline-flex items-center rounded-full border border-sky-500 px-3 py-1 text-xs text-sky-600 hover:bg-sky-50">
              Marcar consulta
            </a>
          </div>
        </article>
        ...
        <article class="doctor-wrapper" data-especialidade="Endodontia">
          <div class="bg-white rounded-2xl shadow-md p-5 text-center">
            ...
            <h3 class="text-sm font-semibold">Dr. Tomás Moreira</h3>
            <p class="mt-1 text-xs text-slate-500">
              Especialista em tratamentos de canal e dor aguda.
            </p>
            <a href="marcacoes.php?especialidade=Endodontia&origem=corpo-clinico" class="mt-3 inline-flex items-center rounded-full border border-sky-500 px-3 py-1 text-xs text-sky-600 hover:bg-sky-50">
              Marcar consulta
            </a>
          </div>
        </article>
        ...
        <article class="doctor-wrapper" data-especialidade="Cirurgia Oral">
          <div class="bg-white rounded-2xl shadow-md p-5 text-center">
            ...
            <h3 class="text-sm font-semibold">Dr. Martim Ferreira</h3>
            <p class="mt-1 text-xs text-slate-500">
              Cirurgias orais, extrações de sisos e pequenas cirurgias.
            </p>
            <a href="marcacoes.php?especialidade=Cirurgia%20oral&origem=corpo-clinico" class="mt-3 inline-flex items-center rounded-full border border-sky-500 px-3 py-1 text-xs text-sky-600 hover:bg-sky-50">
              Marcar consulta
            </a>
          </div>
        </article>
  ...
  <script>
    document.addEventListener('DOMContentLoaded', () => {
      ...
      const doctors = document.querySelectorAll('.doctor-wrapper');

      filterButtons.forEach(btn => {
        btn.addEventListener('click', () => {
          const filter = btn.getAttribute('data-filter');
          filterButtons.forEach(b => {
            b.classList.remove('bg-sky-50', 'border-sky-500', 'text-sky-600');
          ...
          doctors.forEach(card => {
            const esp = card.getAttribute('data-especialidade');
            if (filter === 'todas' || esp === filter) {
