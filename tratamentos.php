...
<body class="font-sans antialiased bg-slate-50 pt-[104px]">
  ...
  <section class="bg-blue-900 text-white py-16 md:py-20">
    <div class="max-w-6xl mx-auto px-4 grid md:grid-cols-2 gap-8 items-center">
      <div>
        ...
        <a href="marcacoes.php?origem=tratamentos"
  ...
  <main class="py-10">
    <section class="max-w-6xl mx-auto px-4">
      ...
      <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
        <!-- Ortodontia -->
        <article id="ortodontia" class="bg-white rounded-2xl shadow-sm hover:shadow-md transition p-5 flex flex-col">
          ...
          <a href="marcacoes.php?tratamento=Ortodontia&origem=tratamentos"
              class="mt-4 block w-full text-center rounded-full border border-sky-500 py-2 text-xs font-semibold text-sky-600 hover:bg-sky-50">
            Marcar consulta
          </a>
        </article>

        <!-- Odontopediatria -->
        <article id="odontopediatria" class="bg-white rounded-2xl shadow-sm hover:shadow-md transition p-5 flex flex-col">
          ...
          <a href="marcacoes.php?tratamento=Odontopediatria&origem=tratamentos"
              class="mt-4 block w-full text-center rounded-full border border-sky-500 py-2 text-xs font-semibold text-sky-600 hover:bg-sky-50">
            Marcar consulta
          </a>
        </article>
        ...
        <!-- Implantes -->
        <article id="implantes" class="bg-white rounded-2xl shadow-sm hover:shadow-md transition p-5 flex flex-col">
          ...
          <a href="marcacoes.php?tratamento=Implantes&origem=tratamentos"
              class="mt-4 block w-full text-center rounded-full border border-sky-500 py-2 text-xs font-semibold text-sky-600 hover:bg-sky-50">
            Marcar consulta
          </a>
        </article>
        ...
        <article class="bg-white rounded-2xl shadow-sm hover:shadow-md transition p-5 flex flex-col">
          ...
          <a href="marcacoes.php?tratamento=Estética dental & Clareamento&origem=tratamentos"
              class="mt-4 block w-full text-center rounded-full border border-sky-500 py-2 text-xs font-semibold text-sky-600 hover:bg-sky-50">
            Marcar consulta
          </a>
        </article>
        ...
        <article class="bg-white rounded-2xl shadow-sm hover:shadow-md transition p-5 flex flex-col">
          ...
          <a href="marcacoes.php?tratamento=Check-up & Higiene oral&origem=tratamentos"
              class="mt-4 block w-full text-center rounded-full border border-sky-500 py-2 text-xs font-semibold text-sky-600 hover:bg-sky-50">
            Marcar consulta
          </a>
        </article>
        ...
        <article class="bg-white rounded-2xl shadow-sm hover:shadow-md transition p-5 flex flex-col">
          ...
          <a href="marcacoes.php?tratamento=Periodontia&origem=tratamentos"
              class="mt-4 block w-full text-center rounded-full border border-sky-500 py-2 text-xs font-semibold text-sky-600 hover:bg-sky-50">
            Marcar consulta
          </a>
        </article>
        ...
        <article class="bg-white rounded-2xl shadow-sm hover:shadow-md transition p-5 flex flex-col">
          ...
          <a href="marcacoes.php?tratamento=Endodontia&origem=tratamentos"
              class="mt-4 block w-full text-center rounded-full border border-sky-500 py-2 text-xs font-semibold text-sky-600 hover:bg-sky-50">
            Marcar consulta
          </a>
        </article>
        ...
        <article class="bg-white rounded-2xl shadow-sm hover:shadow-md transition p-5 flex flex-col">
          ...
          <a href="marcacoes.php?tratamento=Cirurgia oral&origem=tratamentos"
              class="mt-4 block w-full text-center rounded-full border border-sky-500 py-2 text-xs font-semibold text-sky-600 hover:bg-sky-50">
            Marcar consulta
          </a>
        </article>
  ...
  <script>
    function scrollToMarcacao(tratamento = '') {
      const base = 'marcacoes.php';
      if (!tratamento) { window.location.href = base; return; }
      const qs = new URLSearchParams({ tratamento: tratamento, origem: 'tratamentos' });
